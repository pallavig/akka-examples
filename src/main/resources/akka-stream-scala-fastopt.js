...
/** @constructor */
var $c_Lsample_stream_experiments_TutorialApp$ = (function() {
  $c_O.call(this)
});
$c_Lsample_stream_experiments_TutorialApp$.prototype = new $h_O();
$c_Lsample_stream_experiments_TutorialApp$.prototype.constructor = $c_Lsample_stream_experiments_TutorialApp$;
/** @constructor */
var $h_Lsample_stream_experiments_TutorialApp$ = (function() {
  /*<skip>*/
});
$h_Lsample_stream_experiments_TutorialApp$.prototype = $c_Lsample_stream_experiments_TutorialApp$.prototype;
$c_Lsample_stream_experiments_TutorialApp$.prototype.init___ = (function() {
  $n_Lsample_stream_experiments_TutorialApp$ = this;
  return this
});
$c_Lsample_stream_experiments_TutorialApp$.prototype.main__V = (function() {
  var element = $g["document"]["createElement"]("button");
  element["textContent"] = "Magic";
  $g["document"]["appendChild"](element)
});
$c_Lsample_stream_experiments_TutorialApp$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Lsample_stream_experiments_TutorialApp$.prototype["main"] = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Lsample_stream_experiments_TutorialApp$ = new $TypeData().initClass({
  Lsample_stream_experiments_TutorialApp$: 0
}, false, "sample.stream.experiments.TutorialApp$", {
  Lsample_stream_experiments_TutorialApp$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Lsample_stream_experiments_TutorialApp$.prototype.$classData = $d_Lsample_stream_experiments_TutorialApp$;
var $n_Lsample_stream_experiments_TutorialApp$ = (void 0);
var $m_Lsample_stream_experiments_TutorialApp$ = (function() {
  if ((!$n_Lsample_stream_experiments_TutorialApp$)) {
    $n_Lsample_stream_experiments_TutorialApp$ = new $c_Lsample_stream_experiments_TutorialApp$().init___()
  };
  return $n_Lsample_stream_experiments_TutorialApp$
});
$e["sample"] = ($e["sample"] || {});
$e["sample"]["stream"] = ($e["sample"]["stream"] || {});
$e["sample"]["stream"]["experiments"] = ($e["sample"]["stream"]["experiments"] || {});
$e["sample"]["stream"]["experiments"]["TutorialApp"] = $m_Lsample_stream_experiments_TutorialApp$;
...
//# sourceMappingURL=akka-stream-scala-fastopt.js.map
